...
int main (int argc, char *argv[])
{
	...
	/*tenta iniciar o thread, indicando a função 'routine' e passando como argumento a string 
	...
	/*aguarda finalização do thread identificado por thread_id. O retorno é passado pelo ponteiro 
    thread_res*/
